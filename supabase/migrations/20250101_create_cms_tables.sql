...
DROP POLICY IF EXISTS "Service role all job_listings" ON job_listings;
CREATE POLICY "Service role all job_listings"
  ON job_listings FOR ALL
  USING (auth.role() = 'service_role');

DROP POLICY IF EXISTS "Service role all site_images" ON site_images;
CREATE POLICY "Service role all site_images"
  ON site_images FOR ALL
  USING (auth.role() = 'service_role');

DROP POLICY IF EXISTS "Service role all career_applications" ON career_applications;
CREATE POLICY "Service role all career_applications"
